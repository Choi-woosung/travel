...
<body>
	...
	<footer>
		<div class="container">
			<p>All material © 2019 – 2019 MyTravel Company Pte. Ltd., All
				Rights Reserved.</p>
			<p>마이 트레블은 온라인 여행에 관한 각종 정보를 한 곳에서 찾아볼 수 있고 스케쥴을 짤 수 있는 사이트 입니다.
			</p>

			<p>해당 사이트에 등록된 모든 정보는 MyTravel Company 의 지적 자산이므로 당사의 협의없는 상업적
				사용은 불허합니다.</p>
		</div>
	</footer>
</body>
