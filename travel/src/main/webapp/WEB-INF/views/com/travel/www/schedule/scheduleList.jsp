...
<body>
	...
	<div class="container">
		...
		<div class="w3-container w3-margin-bottom w3-card w3-padding">
		<div class="w3-col m1"><p></p></div>
			<div class="w3-col m10">
				<img class="w3-col w3-padding" alt="해당여행사진" src="/img/main/hongkong.jpg" style="width: 400px; height: 400px;">
				<div class="w3-col m5">
